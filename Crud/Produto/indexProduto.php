    ...
    <div class="content">
        <div class="leftDiv">
            <form id="form" method="POST" action="./insertProduto.php">
                ...
                <p>
                    Nome:
                    <input id="pro_Nome" type="text" name="pro_Nome" size="20" style="width:90%">
                </p>
                <p style="display:flex;align-items:flex-start">
                    Detalhes:
                    <textarea id="pro_Detalhe" type="text" name="pro_Detalhe" style="resize:none;width:90%" spellcheck="false"></textarea>
                </p>
                <p>
                    Preço:
                    <input id="pro_Preco" type="number" name="pro_Preco" size="20" style="width:90%">
                </p>
                <p>
                    Foto:
                    <input id="pro_Foto" type="file" accept="image/png, image/gif, image/jpeg, image/webp" style="width:90%" onchange="onFileInputChange(this.files[0])">
